    ...
    <header>
      <div className="flex flex-col md:flex-row items-center p-5 bg-gray-500/10 rounded-b-2xl">
        ...
        <div className="flex items-center space-x-5 justify-end w-full">
          ...
          {/* avatar */}
          <Avatar name="A Miku" round color="#0055D1" size="50" />
        </div>
      </div>
      <div className="flex items-center justify-center px-5 py-2 md:py-5">
        <p className="flex items-center text-sm font-light rounded-xl w-fit p-5 bg-white shadow-xl italic max-w-3xl text-[#0055D1]">
